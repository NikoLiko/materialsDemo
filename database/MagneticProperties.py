# 这个脚本应该    复现matcloud中 MagneticProperties 页面的内容。
...
if __name__ == '__main__':
    #   获得一个 文件夹 ID
    OUTCAR, INCAR, KPOINTS, OSZICAR, POSCAR, vasprun_path = getID('./5a28adf4bd1a248faf08545e')
    ...
    # Properties 部分， 数据来源于 OSZICAR 文件最后一行的最后一个参数 mag
    ...
    run_stats, version, plat = ParseOUTCAR(OUTCAR)
